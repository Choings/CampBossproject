...
public class Board {
	...
	public Board(int board_num, String board_name, String board_addr, String board_info, String board_id,
			int boardcategory1_id, int boardcategory2_id, int boardcategory3_id, int cbboard_hit, MultipartFile file1,
	...
	public String toString() {
		return "Board [board_num=" + board_num + ", board_name=" + board_name + ", board_addr=" + board_addr
				+ ", board_info=" + board_info + ", board_id=" + board_id + ", boardcategory1_id=" + boardcategory1_id
				+ ", boardcategory2_id=" + boardcategory2_id + ", boardcategory3_id=" + boardcategory3_id
				+ ", cbboard_hit=" + cbboard_hit + ", file1=" + file1 + ", file2=" + file2 + ", file3=" + file3 + "]";
	}
