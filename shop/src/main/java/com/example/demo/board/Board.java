...
public class Board {
	...
	public Board(int board_num, String board_name, String board_addr, String board_info, String board_id,
			int boardcategory1_id, int boardcategory2_id, int boardcategory3_id) {
	...
	public Board(int board_num, String board_name, String board_addr, String board_info, String board_id,
			int boardcategory1_id, int boardcategory2_id, int boardcategory3_id, MultipartFile file1,
	...
	public String toString() {
		return "Board [board_num=" + board_num + ", board_name=" + board_name + ", board_addr=" + board_addr
				...
				+ ", boardcategory2_id=" + boardcategory2_id + ", boardcategory3_id=" + boardcategory3_id + ", file1="
